...
void draw() {
  PImage img = loadImage("C:/Users/Roberto/OneDrive/Documentos/Github/Segmentacao_imagens/dataset/placas/55915.jpg");
  PImage img_segmented = loadImage("C:/Users/Roberto/OneDrive/Documentos/Github/Segmentacao_imagens/dataset/placas/55915.png");
  ...
  img1 = aplicar_sequencia_filtros_limiarizacao_color_below(img, aux, "B", 0.99, 1, "1-filtro_cor_azul", 80); 

  //-----------Aplicar sequencia de filtros na imagem gerada anteriormente-------------------//
  aux = aplicar_sequencia_filtros_limiarizacao_color_above(img1, aux, "R", 0.9982, 1, "2-filtro_cor_vermelha", 166);
  
  //------pintar dentro da placa-------------//
  aux = pintar_dentro_de_bordas(img1, aux, "2-filtro_cor_vermelha");
  ...
  image(aux, 0, 0);
  save("resultados/6-imagem_final.jpg");
}

//--------------Pipeline-----------

PImage aplicar_sequencia_filtros_limiarizacao_color_below(PImage img, PImage aux, String cinza_RGB, float paramGauss, int times_to_apply_gauss, String folder_save_images, int color_below) {
  
  //-----------Mostrar imagem original-----------------//
  image(img, 0, 0);
  save("resultados/" + folder_save_images + "/1-original.jpg");
  ...
  aux = show_final_image(img, aux);
  image(aux, 0, 0);
  save("resultados/" + folder_save_images + "/5-color" + cinza_RGB + "-imagem_final.jpg");
  
  return aux;
}

PImage aplicar_sequencia_filtros_limiarizacao_color_above(PImage img, PImage aux, String cinza_RGB, float paramGauss, int times_to_apply_gauss, String folder_save_images, int color_above) {
...
PImage pintar_dentro_de_bordas(PImage img, PImage aux, String folder_save_images) {
  
  //-----------Pintar dentro das bordas-----------------//
  aux = pintar_dentro_das_bordas(img, aux);
  image(aux, 0, 0);
  save("resultados/" + folder_save_images + "/5-pintar-borda.jpg");
