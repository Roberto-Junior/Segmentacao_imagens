...
void draw() {
  PImage img = loadImage("C:/Users/Roberto/OneDrive/Documentos/Github/Segmentacao_imagens/dataset/placas/56108.jpg");
  PImage img_segmented = loadImage("C:/Users/Roberto/OneDrive/Documentos/Github/Segmentacao_imagens/dataset/placas/56108.png");
  ...
  aux = aplicar_sequencia_filtros_borda(img, aux, "B", 1.2, 1, "1-filtro_borda_cor_azul");
...
PImage aplicar_sequencia_filtros_borda(PImage img, PImage aux, String cinza_RGB, float paramGauss, int times_to_apply_gauss, String folder_save_images) {
...
PImage aplicar_OR_logic(PImage img, PImage img1, PImage img2) {
  PImage aux = createImage(img.width, img.height, RGB);
  for (int y = 0; y < img.height; y++) {
    for (int x = 0; x < img.width; x++) {
      int pos = y * img.width + x;
